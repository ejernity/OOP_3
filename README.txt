...
Askisi 3 (Artifacts-Masterpieces-Paintings-Sculptures)
...
1) Run on the command line: make
   Optional: To delete executable and all .o files run on the command line: make clean

2) You have now the executable "askisi3".
